...
public class StockAnalyzer {
    ...
    public static List<Double> calculateSMA(List<Double> prices, int period) {
        ...
        for (int i = 0; i < prices.size(); i++) {
            if (i < period - 1) {
                smaValues.add(Double.NaN); // Not enough data for SMA
            } else {
                double sum = 0.0;
    ...
    public static List<Double> calculateADX(List<StockData> stockData) {
        int period = 14;
    ...
    public static List<Double> calculateCCI(List<StockData> stockData) {
        int period = 20;
    ...
    public static List<StockData> aggregateWeekly(List<StockData> dailyData) {
        ...
        for (int i = 0; i < dailyData.size(); i += 5) { // Assume 5 days in a week
            ...
            weeklyData.add(new StockData(dailyData.get(i).date, close, high, low, avgPrice / 5, volume));
        }
        return weeklyData;
    }
