...
function fetchDashboardData(urlParams) {
    fetch(`http://localhost:8082/api/stocks/dashboard/stats?${urlParams}`)
...
function fetchNews(urlParams) {
    ...
    fetch(`http://localhost:8081/api/stocks/dashboard/news?${urlParams}`)
        .then(response => response.json())
        .then(data => {
...
function fetchLineChart(urlParams) {
    fetch(`http://localhost:8082/api/stocks/dashboard/lineChart?${urlParams}`)
        .then(response => response.json())
        .then(data => {
...
function fetchStatisticsData(urlParams) {
    fetch(`http://localhost:8082/api/stocks/dashboard/statistics?${urlParams}`)
        .then(response => response.json())
        .then(data => {
...
function loadPage() {
    if (isFirst) {
        isFirst = false
        fetch('http://localhost:8081/api/stocks/companies')
            .then(response => response.json())
            .then(data => {
